...
const NotFoundPage = () => (
  <Layout>
    <div className="content" style={{padding: '2rem 13% 0 13%', marginTop:'80px', height: '100%'}}>
          <h1 style={{margin: '0 0 0 7%',}}>Uh Oh...</h1>
          <div className="container" style={{padding: '2rem', fontSize: '90%',}}>
          
          <p style={{textAlign: 'center', fontWeight: 'bold'}}>It seems that we have misplaced the page that you are looking for</p>
