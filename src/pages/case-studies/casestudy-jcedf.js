...
<br /><a href="https://jcedf.org/">https://jcedf.org/</a>
  ...
  <div style={{position:'fixed', backgroundSize:'cover', width:'100%', height:'', zIndex:'-5', display:'block', top:'0' }}><Image className="slider1" alt="Todd Stars" filename="ad2-banner-jcdef.jpg"  /></div>
...
<div className="outer1" style={{padding:'0 ', margin:'0',}}>
<div className="container1" style={{padding:'0', margin:'0', textAlign:'center',}}>
