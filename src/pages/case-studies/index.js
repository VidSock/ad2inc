...
<div className="" style={{alignContent:'top', width:'', margin:'0', padding:'', order:'1', verticalAlign:'top', alignContent:'top',}}>
...
<div className=" " style={{border:'0px solid #fff', position:'relative', margin:'0 0 0 0', borderRadius:'0', width:'', padding:'0 2rem', overflow:'', order:'2', verticalAlign:'top', alignContent:'top',}}>
<h2>Objective:</h2>
