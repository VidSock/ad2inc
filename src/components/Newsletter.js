...
<label htmlFor="email" style={{padding: '.6rem', margin: '1rem 0 1rem 1rem', textAlign: 'left', fontSize: '90%', }}>E-mail / Phone Number:</label>
                ...
                <div className="font" style={{fontSize: '100%', padding: '20px 3%', textAlign: 'center',}}> <input type="checkbox" name={'consent'} required={true} style={{transform: 'scale(2)', margin: '0 10px 0 0', background:'#ff0000', color:'#ff0000',}} /> <label htmlFor={'consent'}>I want to participate by email or text.</label></div>
