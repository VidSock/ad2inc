...
<label className="label" htmlFor={'message'} style={{padding: '0', margin: '0',}}>
                ...
                <div style={{fontSize: '70%', padding: '0 3%', margin: '0 0 1rem 0', textAlign: 'center',}}> <input type="checkbox"  name={'consent'} required={true} style={{transform: 'scale(2)', margin: '0 10px 0 0', padding: '0',}} />  <label htmlFor={'consent'}>I want to communicate by email or text.</label></div>
