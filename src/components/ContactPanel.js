...
<h2 className="" style={{textAlign:'center', margin:'1rem 0', fontSize:'110%',}}>
Schedule your free consultation today:
                ...
                <label htmlFor="email" style={{padding: '0', margin: '0',}}>Your email:</label>
                    ...
                    <label htmlFor="attachment1" style={{padding: '0', margin: '0 2.5% 0 0', float: 'left', width: '', fontSize:'70%', color: '#333', textShadow:'none'}}>
                    ZIP files preferred
                    <input
